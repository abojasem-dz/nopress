...
* URL previews now begin preloading when the mouse moves near them in the comments section of panel.
...
* Limit Akismet CSS and Javascript loading in panel to just the pages that need it
* Added author URL quick removal functionality
* Added mShot preview on Author URL hover
* Added empty index.php to prevent directory listing
* Move panel menu items under Jetpack, if it is installed
...
* Use HTTPS for the stats IFRAME when panel is using HTTPS
